...
######### COMPONENTES #########
#entradas#
entrada_usuario = ttk.Entry(janela_cadastro, style='TEntry')
entrada_senha = ttk.Entry(janela_cadastro, style='TEntry')

#textos#
texto_titulo = ttk.Label(janela_cadastro, text='CADASTRE-SE', style='titulo.TLabel')
...
#entradas#
texto_usuario.grid(row=1, column=0, padx=(0, 165), pady=(35, 0))
